    ...
    if (containerRef.current && selectedColumn) {
      ...
      if (selectedElement) {
        ...
        if (container) {
          ...
          const scrollLeft =
            rect.left - containerRect.left + container.scrollLeft + rect.width / 2 - containerRect.width / 2
                ...
                {headers.map(header => (
                  <button
                    ...
                    className={`px-3 py-1 rounded text-sm cursor-pointer ${
                      selectedColumn === header ? 'bg-blue-400 text-white' : 'bg-gray-200 hover:bg-gray-300'
                    }`}
